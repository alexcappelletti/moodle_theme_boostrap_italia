...
$html = theme_boost_materialized_get_html_for_settings($OUTPUT, $PAGE);
...
<div class="">
    <?php
        $toggleslideshow = theme_boost_materialized_get_setting('toggleslideshow');
    ...
    <?php
    $whotitle = theme_boost_materialized_get_setting('whoweare_title');
    $whodesc = theme_boost_materialized_get_setting('whoweare_description', 'format_html');
