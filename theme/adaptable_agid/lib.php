 ...
 * @return string
 */
function theme_adaptable_agid_process_css($css, $theme) {
    // Set the background image for the logo.
    $logo = $theme->setting_file_url('logo', 'logo');
    $css = theme_adaptable_agid_set_logo($css, $logo);
    // Set custom CSS.
   
    // $css = theme_adaptable_agid_set_customcss($css, $customcss);
    // $css = theme_adaptable_agid_pre_css_set_fontwww($css);
    return $css;
}
 ...
 */
function theme_adaptable_agid_set_logo($scss, $logo) {
    $tag = '$logo: ';
    $replacement = $logo;
 ...
 * @return bool
 */
// function theme_adaptable_agid_pluginfile($course, $cm, $context, $filearea, $args, $forcedownload, array $options = array()) {
//     static $theme;
//     if (empty($theme)) {
//         $theme = theme_config::load('adaptable_agid');
//     }
...
//             theme_adaptable_agid_serve_css($args[1]);
 ...
 * @return string
 */
function theme_adaptable_agid_serve_css($filename) {
    global $CFG;
    if (!empty($CFG->themedir)) {
        $thestylepath = $CFG->themedir . '/adaptable_agid/style/';
    } else {
        $thestylepath = $CFG->dirroot . '/theme/adaptable_agid/style/';
    }
    ...
    if ((($ifmodifiedsince) && (strtotime($ifmodifiedsince) == $lastmodified)) || $etagheader == $etagfile) {
        theme_adaptable_agid_send_unmodified($lastmodified, $etagfile);
    }
    theme_adaptable_agid_send_cached_css($thestylepath, $filename, $lastmodified, $etagfile);
}
 ...
 * @param  string $etag
 */
function theme_adaptable_agid_send_unmodified($lastmodified, $etag) {
 ...
 * @param  string $etag
 */
function theme_adaptable_agid_send_cached_css($path, $filename, $lastmodified, $etag) {
    global $CFG;
 ...
 */
// function theme_adaptable_agid_set_customcss($css, $customcss) {
 ...
 */
function theme_adaptable_agid_get_html_for_settings(renderer_base $output, moodle_page $page) {
    global $CFG;
    $return = new stdClass;
    $return->navbarclass = '';
 ...
 * @return string
 */
// function theme_adaptable_agid_set_fontwww() {
//     global $CFG, $PAGE;

//     $themewww = $CFG->wwwroot."/theme";
//     $theme = theme_config::load('adaptable_agid');
//     $fontwww = '$fontwww: "'. $themewww.'/adaptable_agid/fonts/"'.";\n";
//     return $fontwww;
// }
 ...
 * @return string
 */
// function theme_adaptable_agid_pre_css_set_fontwww($css) {
//     global $CFG, $PAGE;

//     $themewww = $CFG->wwwroot."/theme";
//     $tag = '[[setting:fontwww]]';
//     $theme = theme_config::load('adaptable_agid');
//     $css = str_replace($tag, $themewww.'/adaptable_agid/fonts/', $css);
//     return $css;
// }
 ...
 * @return image
 */
function theme_adaptable_agid_render_slideimg($p, $sliname) {
    global $PAGE, $OUTPUT;
    $nos = theme_adaptable_agid_get_setting('numberofslides');
    $i = $p % 3;
    $slideimage = '';
    if (theme_adaptable_agid_get_setting($sliname)) {
 ...
 * @return string
 */
function theme_adaptable_agid_get_setting($setting, $format = true) {
    global $CFG;
 ...
 * @return type|string
 */
function theme_adaptable_agid_infolink() {
    $infolink = theme_adaptable_agid_get_setting('infolink');
    $content = "";
...
function theme_adaptable_agid_lang($key = '') {
    $pos = strpos($key, 'lang:');
    if ($pos !== false) {
        list($l, $k) = explode(":", $key);
        if (get_string_manager()->string_exists($k, 'theme_adaptable_agid')) {
            $v = get_string($k, 'theme_adaptable_agid');
            return $v;
        } else {
            return $key;
        }
