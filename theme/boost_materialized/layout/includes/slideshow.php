...
$numberofslides = theme_boost_materialized_get_setting('numberofslides');
$slideimage = array();
for ($s1 = 1; $s1 <= $numberofslides; $s1++) {
    $slideimage [] = theme_boost_materialized_render_slideimg($s1, 'slide' . $s1 . 'image');
}
        ...
        <div class="theme-slider">
          <div id="home-page-carousel" class="carousel slide" data-ride="carousel" data-interval= "2000">
            ...
            <div class="carousel-inner" role="listbox">
                ...
                $visableslide = 0;
                for($s1 = 1; $s1 <= $numberofslides; $s1++):
                    $slidecaption = theme_boost_materialized_get_setting('slide' . $s1 . 'caption', true);
                    $slideimg = theme_boost_materialized_render_slideimg($s1, 'slide' . $s1 . 'image');
                    $icon = "fa-angle-right";
                    if (right_to_left()) {
                        $icon = "fa-angle-left";
                    }
                    $content = '';
                    $slidebtn = theme_boost_materialized_get_setting('slide'.$s1.'urltext');
                    //$slidebtn = theme_boost_materialized_lang($slidebtn);
                    $slideurl = theme_boost_materialized_get_setting('slide' . $s1 . 'url');
