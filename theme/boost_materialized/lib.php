 ...
 */
function theme_boost_materialized_page_init(moodle_page $page) {
    $page->requires->jquery();
    $page->requires->js('/theme/boost_materialized/javascript/theme.js');
}
...
function theme_boost_materialized_process_css($css, $theme) {
    ...
    // $css = theme_boost_materialized_pre_css_set_fontwww($css);
    return $css;
}
 ...
 */
function theme_boost_materialized_set_logo($scss, $logo) {
    $tag = '$logo: ';
    $replacement = $logo;
 ...
 * @return bool
 */
// function theme_boost_materialized_pluginfile($course, $cm, $context, $filearea, $args, $forcedownload, array $options = array()) {
//     static $theme;
//     if (empty($theme)) {
//         $theme = theme_config::load('boost_materialized');
//     }
...
//             theme_boost_materialized_serve_css($args[1]);
 ...
 * @return string
 */
function theme_boost_materialized_serve_css($filename) {
    global $CFG;
    if (!empty($CFG->themedir)) {
        $thestylepath = $CFG->themedir . '/boost_materialized/style/';
    } else {
        $thestylepath = $CFG->dirroot . '/theme/boost_materialized/style/';
    }
    ...
    if ((($ifmodifiedsince) && (strtotime($ifmodifiedsince) == $lastmodified)) || $etagheader == $etagfile) {
        theme_boost_materialized_send_unmodified($lastmodified, $etagfile);
    }
    theme_boost_materialized_send_cached_css($thestylepath, $filename, $lastmodified, $etagfile);
}
 ...
 * @param  string $etag
 */
function theme_boost_materialized_send_unmodified($lastmodified, $etag) {
 ...
 * @param  string $etag
 */
function theme_boost_materialized_send_cached_css($path, $filename, $lastmodified, $etag) {
    global $CFG;
 ...
 */
// function theme_boost_materialized_set_customcss($css, $customcss) {
 ...
 */
function theme_boost_materialized_get_html_for_settings(renderer_base $output, moodle_page $page) {
    global $CFG;
    $return = new stdClass;
    $return->navbarclass = '';
 ...
 * @return string
 */
// function theme_boost_materialized_set_fontwww() {
//     global $CFG, $PAGE;

//     $themewww = $CFG->wwwroot."/theme";
//     $theme = theme_config::load('boost_materialized');
//     $fontwww = '$fontwww: "'. $themewww.'/boost_materialized/fonts/"'.";\n";
//     return $fontwww;
// }
 ...
 * @return string
 */
// function theme_boost_materialized_pre_css_set_fontwww($css) {
//     global $CFG, $PAGE;

//     $themewww = $CFG->wwwroot."/theme";
//     $tag = '[[setting:fontwww]]';
//     $theme = theme_config::load('boost_materialized');
//     $css = str_replace($tag, $themewww.'/boost_materialized/fonts/', $css);
//     return $css;
// }
 ...
 * @return image
 */
function theme_boost_materialized_render_slideimg($p, $sliname) {
    global $PAGE, $OUTPUT;
    $nos = theme_boost_materialized_get_setting('numberofslides');
    $i = $p % 3;
    $slideimage = '';
    if (theme_boost_materialized_get_setting($sliname)) {
 ...
 * @return string
 */
function theme_boost_materialized_get_setting($setting, $format = true) {
    global $CFG;
 ...
 * @return type|string
 */
function theme_boost_materialized_infolink() {
...
function theme_boost_materialized_lang($key = '') {
    $pos = strpos($key, 'lang:');
    if ($pos !== false) {
        list($l, $k) = explode(":", $key);
        if (get_string_manager()->string_exists($k, 'theme_boost_materialized')) {
            $v = get_string($k, 'theme_boost_materialized');
            return $v;
        } else {
            return $key;
        }
