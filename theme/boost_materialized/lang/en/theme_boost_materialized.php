...
$string['choosereadme'] = 'Theme boost_materialized is a child theme of Boost. Done by alex for testing bootstrap themes.';                
// The name of our plugin.                                                                                                          
$string['pluginname'] = 'boost_materialized';                                                                                                    
...
$string['choosereadme'] = '<div class="clearfix"><div class="theme_screenshot"><img class=img-polaroid src="boost_materialized/pix/screenshot.jpg" /><br/><p></p><h3>Theme Credits</h3><p><h3>Moodle boost_materialized theme</h3><p>This theme is based on the Boost Moodle theme.</p><p>Authors: LMSACE Dev Team<br>Contact: info@lmsace.com<br>Website: <a href="http://www.lmsace.com">www.lmsace.com</a><br></p>';

$string['configtitle'] = 'boost_materialized';
...
$string['home'] = "Home";
$string['privacy:metadata'] = 'The boost_materialized theme does not store any personal data about any user.';