...
//     return theme_sample_get_main_scss_content($theme);                                                                               
// };
$THEME->scss = function($theme){
	return theme_sample_get_local_scss2();
};
//$THEME->precompiledcsscallback = 'theme_sample_get_precompiled_css';
